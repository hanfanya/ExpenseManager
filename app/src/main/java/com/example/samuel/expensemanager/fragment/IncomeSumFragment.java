 ...
 */
public class IncomeSumFragment extends Fragment implements RadioGroup.OnCheckedChangeListener, View.OnClickListener, OnChartValueSelectedListener {
    ...
    private void setChangeDate(String startDate, String endDate) {
        ...
        //从数据库获取总支出
        String sqlSum = "select sum(figure) from EXPENSE where TYPE_FLAG=0  and UPLOAD_FLAG in (0,1,5,8) and DATE between " + NumberStartDate + "  and  " + NumberEndDate + ";";
        ...
        String sql = "select sum(figure),type_name,type_color from EXPENSE where TYPE_FLAG=0 and  UPLOAD_FLAG in (0,1,5,8) and DATE between " + NumberStartDate + " and " + NumberEndDate + "  group by type_name order by sum(figure) desc;";
